...
public class utilityHelper {
    ...
    a-z, A-Z, 0-9
     */
    public static boolean checkUser(JTextField txt) {
...
//        }
    ...
    //gio là int >0
    public static boolean checkSoNguoi(JTextField txt) {
        txt.setBackground(white);
        try {
    ...
    public static boolean checkNullTextSN(JTextField txt) {
        ...
        if (txt.getText().equalsIgnoreCase("Số người")) {
            txt.setBackground(pink);
            DialogHelper.alert(txt.getRootPane(), "Số người không được để trống ");
            return false;           
        } else {
            return true;
        }
    ...
    public static boolean checkNullTextDK(JTextField txt) {
        txt.setBackground(white);
        if (txt.getText().equals("Họ tên")) {
            txt.setBackground(pink);
            DialogHelper.alert(txt.getRootPane(), "Họ tên không được để trống ");
            return false;           
        } else if (txt.getText().equals("Số điện thoại")) {
            txt.setBackground(pink);
            DialogHelper.alert(txt.getRootPane(), "Số điện thoại không được để trống ");
            return false;
        } else if (txt.getText().equals("Tên đăng nhập")) {
            txt.setBackground(pink);
            DialogHelper.alert(txt.getRootPane(), "Tên đăng nhập không được để trống ");
            return false;           
